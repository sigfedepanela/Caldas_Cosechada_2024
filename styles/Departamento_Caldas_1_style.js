...
var style_Departamento_Caldas_1 = function(feature, resolution){
    ...
    if (value >= 0.000000 && value <= 1.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.000000 && value <= 83.684056) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 83.684056 && value <= 213.859254) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 213.859254 && value <= 329.157287) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 329.157287 && value <= 1211.559167) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1211.559167 && value <= 1521.190175) {
            style = [ new ol.style.Style({
